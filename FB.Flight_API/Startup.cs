    ...
    public class Startup
    {
        ...
        .AddJwtBearer(x =>
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FB.Flight_API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FB.Flight_API v1"));
            }
